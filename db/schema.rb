...
ActiveRecord::Schema.define(version: 2019_08_03_095351) do
  ...
  create_table "favorite_articles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["favorite_id"], name: "index_favorite_articles_on_favorite_id"
  end
  ...
  create_table "like_articles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["like_id"], name: "index_like_articles_on_like_id"
  end
  ...
  add_foreign_key "favorite_articles", "favorites"
  add_foreign_key "favorites", "users"
  add_foreign_key "like_articles", "articles"
  add_foreign_key "like_articles", "likes"
